...
(defcustom eglot-java-eclipse-jdt-args
  '("-Xmx1G"
    ...
    "-Dosgi.sharedConfiguration.area=/nix/store/15dvj1sywr30z2j9ffdh07kgy75jr010-jdt-language-server-1.31.0/share/java/jdtls/config_linux/config.ini" 
...
(defcustom eglot-java-eclipse-jdt-config-directory
  (file-truename "/nix/store/k3fnfk4ckqcb2l8pmijq84nhrrd4bss3-jdt-language-server-1.31.0/share/java/jdtls/config_linux")
...
(defcustom eglot-java-server-install-dir
  (file-truename "store/k3fnfk4ckqcb2l8pmijq84nhrrd4bss3-jdt-language-server-1.31.0/bin")
